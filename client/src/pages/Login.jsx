...
export default function Login() {
  ...
  useEffect(() => {
    if (showAtpModal && atpInputRef.current) {
      const timer = setTimeout(() => {
        atpInputRef.current?.focus();
      }, 50);
  ...
  useEffect(() => {
    if (showForgotModal && forgotInputRef.current) {
      const timer = setTimeout(() => {
  ...
  const handleForgotClick = useCallback((e) => {
    e.preventDefault();
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        const errorMessages = {
          'user-banned': 'Your account has been banned. Contact support if you believe this is an error.',
        ...
        setError(errorMessages[errCode] || errCode || 'Login failed');
        ...
        {(providers.github || providers.google || providers.atproto) && (
          <>
            <div className="oauth-providers">
              {providers.github && (
                <a className="oauth-btn" href="/auth/github" title="Continue with GitHub">
              ...
              {providers.google && (
                <a className="oauth-btn" href="/auth/google" title="Continue with Google">
              ...
              {providers.atproto && (
                <button type="button" className="oauth-btn" onClick={handleAtprotoClick} title="Continue with Bluesky">
        ...
        >
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <div className="modalHeader">
              <div className="modalTitle">Sign in with ATProto</div>
        ...
        >
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <div className="modalHeader">
              ...
              <button className="iconBtn" onClick={() => setShowForgotModal(false)} aria-label="Close">
                ✕
              </button>
            </div>
            <div className="modalBody">
              {forgotSuccess ? (
                <>
                  <div style={{ textAlign: 'center', padding: '16px 0' }}>
                    ...
                    <p style={{ color: '#5a6d9a', marginBottom: 8 }}>
                      If an account exists with that email, we've sent a password reset link.
                    </p>
                    <p style={{ color: '#94a3b8', fontSize: 13 }}>Check your inbox and spam folder.</p>
                  </div>
                  <div className="modalActions">
                    <button className="btn primary" type="button" onClick={() => setShowForgotModal(false)}>
                      Done
                    </button>
                  </div>
                </>
